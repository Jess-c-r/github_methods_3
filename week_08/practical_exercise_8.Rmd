...
for i in range(n):
    if y[i] == 1 or y[i] == 2:
        data_1_2.append(y[i])
#Comes out as a list, but in the next part it needs to be an array, so I'm just transforming it now - not sure if there's a way to make it as an array from the start?
data_1_2 = np.array(data_1_2)

print(data_1_2) #Is it supposed to look like this
...
StandardScaler.transform(X_1_2)

#??? Transform doesn't work, but not sure what else to do
```
